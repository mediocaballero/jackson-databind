...
//            }
    ...
    protected static class ContainerDefaultMappings {
        ...
        static {
            HashMap<String, Class<? extends Collection>> fallbacks = new HashMap<String, Class<? extends Collection>>();
        ...
        static {
            HashMap<String, Class<? extends Map>> fallbacks = new HashMap<String, Class<? extends Map>>();
